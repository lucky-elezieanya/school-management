...
import { apiHeaders, BASE_URL, fetchClasses } from "@/app/lib/api";
...
export default function StudentsPage() {
  ...
  const filteredStudents = students.filter((student) =>
    ...
    } ${student.admission_number} ${student.user.gender}`
      .toLowerCase()
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-linear-to-r from-emerald-700 to-emerald-500 text-white px-6 py-8 shadow-lg">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <Link
            href={`${user?.role === "admin" ? "/admin/administration" : "/teachers/students"}`}
                      ...
                      >
                        <td className="px-2 py-5">
                          <div className="flex items-center gap-4">
                            <img
                              src={
                                student.user.profile_picture || "/avatar.png"
                              }
                              alt="profile"
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center justify-center gap-3">
                            <Link
                              href={`${user?.role === "admin" ? `/admin/administration/students/${student.id}` : `/teachers/students/${student.id}`}`}
