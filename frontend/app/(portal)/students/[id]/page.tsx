...
export default function Student() {
  ...
  return (
    <div className="min-h-screen bg-pink-50">
      {/* HEADER */}
      <div className="bg-linear-to-r from-blue-700 to-blue-500 text-white px-6 py-8 shadow-lg">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-teal-500 hover:bg-teal-600 transition px-5 py-3 rounded-xl font-medium shadow"
            >
              <Pencil size={18} />
              Edit Profile
            </button>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-lg p-6">
              <div className="flex flex-col items-center">
                <div className="relative w-36 h-36 rounded-full overflow-hidden border-4 border-blue-100 shadow-md">
                  <Image
                ...
                <div className="mt-4 px-4 py-2 rounded-full bg-blue-100 text-blue-800 text-sm font-semibold">
                  Student
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                <button
                  className="w-full bg-blue-700 hover:bg-blue-800 transition text-white py-3 rounded-xl font-medium"
                  onClick={() =>
                    router.push(
                      `/students/${studentId}/result?class_id=${student.current_enrollment.school_class.id}&term_id=${currentTerm?.id}&session_id=${currentTerm?.session.id}`,
                    )
                  }
                >
                  View Results
...
function StatCard({ title, value }: { title: string; value: string }) {
  return (
    <div className="bg-linear-to-br from-blue-700 to-blue-900 text-white rounded-3xl p-6 shadow-lg">
