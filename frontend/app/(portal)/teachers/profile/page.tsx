...
export default function AdminTeachersPage() {
	...
	return (
		<div className="min-h-screen bg-gray-100">
			{/* HEADER */}
			<div className="bg-linear-to-r from-green-900 to-green-700 text-white px-6 py-8 shadow-lg">
				<div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
					...
					<div className="link flex gap-3 md:gap-6 justify-center md:justify-start ">
						<Link
							...
							className="inline-flex items-center gap-2 bg-green-400 hover:bg-green-500 px-4 py-2 transition rounded-xl font-semibold shadow-md"
						>
							<ArrowLeft size={18} />
							<span>Go Back</span>
						</Link>
				...
				<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
					<div className="relative">
						...
						<input
							...
							className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-700"
						/>
					</div>
				</div>
											...
											<td className="px-6 py-5">
												<div className="flex items-center justify-center gap-3">
													<Link
														...
														className="w-10 h-10 rounded-xl bg-green-100 hover:bg-green-200 flex items-center justify-center text-green-800 transition"
													>
														<Eye size={18} />
													</Link>
