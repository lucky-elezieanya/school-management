...
export default function ClassesPage() {
  ...
  const handleArmSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await createAction("academics", "arms", payload, "POST");
  ...
  const handleClassSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await createAction("academics", "classes", payload, "POST");
  ...
  const fetchClasses = async () => {
    try {
      const res = await fetch(`${BASE_URL}/academics/classes/summary/`, {
        headers: apiHeaders(),
      });
      const data = await res.json();

      const classesData = data.results || [];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="bg-transparent rounded-3xl shadow-sm border border-gray-200 p-6 lg:col-span-2">
            ...
            <form onSubmit={handleClassSubmit} className="space-y-5">
              ...
              <div className="pt-2 gap-4 flex-col flex md:flex-row">
                ...
                <button
                  onClick={() =>
                    router.push("/admin/administration/classes/upload")
                  }
                  type="button"
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            onClick={() =>
                              router.push(
                                `/admin/administration/classes/${cls.id}/edit`,
                              )
                            }
        ...
        <div className="bg-transparent rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            <h2 className="text-xl font-semibold text-gray-800">Class Arms</h2>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">{arm.code}</p>
                    </div>
                  </div>
