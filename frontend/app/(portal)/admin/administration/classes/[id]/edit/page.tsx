  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        /* CLASS */
        const cls: ClassType = await apiAction("academics", "classes", classId);
        ...
        setForm({
          ...
          class_teacher: cls.class_teacher ? cls.class_teacher.id : undefined,
        });
      } catch (err) {
        console.error(err);
      } finally {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* ARM */}
            <div>
              <label className="text-sm font-medium text-gray-700">Arm</label>
              ...
              >
                <option value="">Active Arm ({form.arm})</option>
                {arms?.length > 0 &&
                  arms.map((arm) => (
