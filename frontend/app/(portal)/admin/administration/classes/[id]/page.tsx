...
import { ClassType, SubjectType } from "@/app/lib/types";
...
export default function IndividualClassPage() {
  ...
  const handleToggleActiveStatus = async (
    ...
    await toggleStudentActiveStatus(studentId, actionName);
    fetchData();
  };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-gray-600 max-w-3xl">
                {classData?.description || "No class description available"}
              </p>
            </div>
          </div>

          <Link
            href={`/admin/administration/classes/${classId}/edit`}
            className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-xl transition font-medium text-center"
          >
            Edit Class
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="text-3xl font-bold mt-2">{subjects.length}</h2>
              </div>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Class Teacher</p>

                <h2 className="text-lg font-bold mt-2">
                  {classData?.class_teacher?.user.full_name || "N/A"}
                </h2>
              </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6">
          ...
          {classData?.class_teacher ? (
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <img
                src={
                  classData.class_teacher.user.profile_picture || "/avatar.png"
                }
                alt="Teacher"
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">
                      {classData.class_teacher.phone_number}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-5">
                  <Link
                    href={`/admin/administration/teachers/${classData.class_teacher.id}`}
            ...
            <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
              <p className="text-red-600">No class teacher assigned</p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href={`/admin/administration/classes/${classId}/subjects`}
                ...
                {students.length > 0 ? (
                  students.map((student) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">{student.user.username}</td>
                      ...
                      <td className="px-2 py-2 flex flex-row gap-2 items-center">
                        ...
                        {student && student.is_active ? (
                          <div className="gap-2 flex">
                            <button
                              type="button"
                              className="outline-none  px-4 py-2 rounded-lg border border-green-400 text-green-400"
                            >
                              Active
                            </button>
                            <button
                              ...
                              type="button"
                              className="bg-yellow-300 text-gray-100 px-4 py-2 rounded-lg border border-yellow-400"
                            >
                              Deactivate
                            </button>
                          </div>
                          ...
                          <div className="gap-2 flex">
                            <button
                              type="button"
                              className="bg-red-400 text-gray-50 px-4 py-2 outline-none rounded-lg border-gray-400"
                            >
                              Inactive
                            </button>
