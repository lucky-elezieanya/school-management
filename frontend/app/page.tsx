          ...
          <div className="animate-in fade-in slide-in-from-left duration-700">
            ...
            <div className="grid grid-cols-3 gap-4 mt-12">
              <div className="bg-white rounded-2xl p-4 shadow-sm border">
                <h3 className="text-2xl font-bold text-emerald-900">300+</h3>
                <p className="text-sm text-gray-500">Students</p>
              </div>

              <div className="bg-white rounded-2xl p-4 shadow-sm border">
                <h3 className="text-2xl font-bold text-emerald-900">30+</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-900 to-emerald-700 text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="mt-5 text-emerald-100 text-lg">
            Join Cozzi Schools today and experience quality education built on
            Christian values.
          </p>
